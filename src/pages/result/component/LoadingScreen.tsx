...
export default function LoadingScreen({ isDataReady, onComplete }: LoadingScreenProps) {
  ...
  return (
    <div className="fixed top-16 left-0 right-0 bottom-0 z-40 overflow-y-auto w-full bg-[#121212] text-white font-sans">
      <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center pt-10 pb-20 px-4 relative">
        ...
        <div className="w-full max-w-5xl mt-12 flex flex-col items-center">
          ...
          {isFetching ? (
            ...
            <div className="flex gap-4 w-full overflow-x-auto pb-4 justify-start lg:justify-center">
